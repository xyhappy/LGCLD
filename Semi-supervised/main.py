...
if __name__ == '__main__':
    ...
    for suffix in [0, 1, 2, 3, 4]:
        ...
        for model_epoch in model_epochs:
            ...
            args.model_PATH = '{}/{}_alpha={}_flag={}_lr={}_momentum={}_epoch={}_suffix={}_model.pt'.format(args.save_model, args.dataname, args.alpha, args.flag, args.lr, args.momentum, args.model_epoch, args.suffix)
    ...
    print('For alpha={}, flag={}, lr={}, momentum={}, model_epoch={}, mean_acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, model_epochs[0], mean_acc[0], mean_std[0]))
    print('For alpha={}, flag={}, lr={}, momentum={}, model_epoch={}, mean_acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, model_epochs[1], mean_acc[1], mean_std[1]))
    print('For alpha={}, flag={}, lr={}, momentum={}, model_epoch={}, mean_acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, model_epochs[2], mean_acc[2], mean_std[2]))
    print('For alpha={}, flag={}, lr={}, momentum={}, model_epoch={}, mean_acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, model_epochs[3], mean_acc[3], mean_std[3]))
    print('For alpha={}, flag={}, lr={}, momentum={}, model_epoch={}, mean_acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, model_epochs[4], mean_acc[4], mean_std[4]))
    print('For alpha={}, flag={}, lr={}, momentum={}, Best Epoch={}, Final Test Acc: {:.2f} ± {:.2f}'.format(args.alpha, args.flag, args.lr, args.momentum, best_epoch, final_acc, final_std))
