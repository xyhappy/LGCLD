...
if __name__ == '__main__':
    ...
    print('alpha: {}, flag: {}, momentum: {}'.format(args.alpha, args.flag, args.momentum))
    print('================')
    ...
    for seed in [0, 1, 2, 3, 4]:
        ...
        accuracies = {'val': [], 'test': []}
        path = osp.join('/home/xuyuhua/ssd/code/Contrastive_Methods/pyg_data', args.dataname)
        ...
        model = Net(args.num_features, args.hidden_dim, args.num_gc_layers, args.alpha, args.flag, args.momentum).to(args.device)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % args.epochs == 0:
                torch.save(
                    model.state_dict(),
                    '{}/{}_seed={}_alpha={}_flag={}_momentum={}_model.pth'.format(args.checkpoints, args.dataname,args.seed, args.alpha, args.flag, args.momentum)
                )
